        ...
        parsers: parsers = {
                ...
                variable: function () {
                    ...
                    if (parserInput.currentChar() === '@' && (name = parserInput.$re(/^@@?[\w-]+/))) {
                        ...
                        if (ch === '(' || ch === '[') {
                            ...
                            return parsers.variableCall(name);
                        }
            ...
            mixin: {
                ...
                ruleLookups: function() {
                    ...
                    console.log(parserInput.currentChar());
                    while (true) {
                        parserInput.save();
                        args = null;
