...
var variable_ref_1 = require("./variable-ref");
var property_ref_1 = require("./property-ref");
/**
...
var Quoted = /** @class */ (function (_super) {
    ...
    Quoted.prototype.eval = function (context) {
        ...
        var variableReplacement = function (_, name) {
            var v = new variable_ref_1.default("@" + name, that.getIndex(), that.fileInfo()).eval(context, true);
            return (v instanceof Quoted) ? v.value : v.toCSS();
        };
        var propertyReplacement = function (_, name) {
            var v = new property_ref_1.default("$" + name, that.getIndex(), that.fileInfo()).eval(context, true);
            return (v instanceof Quoted) ? v.value : v.toCSS();
        };
