...
var AtRule = /** @class */ (function (_super) {
    ...
    function AtRule(props, options, location) {
        var _this = this;
        ...
        _this = _super.call(this, rest, options, location) || this;
        _this.name = name;
        var i;
        _this.name = name;
        _this.value = (value instanceof node_1.default) ? value : (value ? new Anonymous(value) : value);
        if (rules) {
