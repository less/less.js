...
type MockSourceMapNode struct {
	GenCSSFunc func(context map[string]any, output *SourceMapOutput)
}

func (m *MockSourceMapNode) GenCSS(context map[string]any, output *SourceMapOutput) {
	if m.GenCSSFunc != nil {
		m.GenCSSFunc(context, output)
	}
}

func (m *MockSourceMapNode) GenCSSSourceMap(context map[string]any, output *SourceMapOutput) {
	if m.GenCSSFunc != nil {
		m.GenCSSFunc(context, output)
	}
}
...
func TestSourceMapOutput(t *testing.T) {
	t.Run("constructor", func(t *testing.T) {
		t.Run("should initialize with basic options", func(t *testing.T) {
			mockRootNode := &MockSourceMapNode{}
	...
	t.Run("ToCSS", func(t *testing.T) {
		...
		t.Run("should generate CSS and source map", func(t *testing.T) {
			sourceMapOutput.rootNode = &MockSourceMapNode{
				GenCSSFunc: func(context map[string]any, output *SourceMapOutput) {
