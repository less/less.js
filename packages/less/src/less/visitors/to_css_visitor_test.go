...
func (m *mockCall) GetType() string   { return m.typeStr }
func (m *mockCall) GetName() string   { return m.name }
func (m *mockCall) GetIndex() int     { return m.index }
func (m *mockCall) FileInfo() any     { return m.fileInfo }
...
func (m *mockRuleset) GetType() string          { return m.typeStr }
func (m *mockRuleset) GetRoot() bool            { return m.root }
func (m *mockRuleset) GetFirstRoot() bool       { return m.firstRoot }
func (m *mockRuleset) GetRules() []any          { return m.rules }
func (m *mockRuleset) SetRules(r []any)         { m.rules = r }
func (m *mockRuleset) GetPaths() []any          { return m.paths }
func (m *mockRuleset) SetPaths(p []any)         { m.paths = p }
func (m *mockRuleset) GetIndex() int            { return m.index }
func (m *mockRuleset) FileInfo() any            { return m.fileInfo }
func (m *mockRuleset) GetAllowRoot() bool       { return m.allowRoot }
func (m *mockRuleset) Accept(v *Visitor)        {}
func (m *mockRuleset) EnsureVisibility()        { m.visibility = true }
func (m *mockRuleset) IsVisible() bool          { return m.visibility }
