...
export default class ProcessExtendsVisitor {
    constructor() {
        this._visitor = new Visitor(this);
    }
    ...
    doExtendChaining(extendsList, extendsListTarget, iterationCount) {
        ...
        let extendIndex, targetExtendIndex, matches;
        const extendsToAdd = [];
        let newSelector, selectorPath, extend, targetExtend, newExtend;
        ...
        for (extendIndex = 0; extendIndex < extendsList.length; extendIndex++) {
            for (targetExtendIndex = 0; targetExtendIndex < extendsListTarget.length; targetExtendIndex++) {
                ...
                if ( extend.parent_ids.indexOf(targetExtend.object_id) === -1 ) { continue; }
                ...
                if (matches.length) {
                    ...
                    extend.selfSelectors.forEach(selfSelector => {
                        ...
                        newSelector = this.extendSelector(matches, selectorPath, selfSelector, extend.isVisible());
        ...
        if (extendsToAdd.length) {
            ...
            // d extending e...
            return extendsToAdd.concat(this.doExtendChaining(extendsToAdd, extendsListTarget, iterationCount + 1));
        } else {
            return extendsToAdd;
        }
    }
    ...
    visitRuleset(rulesetNode, visitArgs) {
        ...
        let matches, pathIndex, extendIndex;
            ...
            for (pathIndex = 0; pathIndex < rulesetNode.paths.length; pathIndex++) {
                ...
                if (matches.length) {
                    ...
                    allExtends[extendIndex].selfSelectors.forEach(selfSelector => {
                        const extendedSelectors = this.extendSelector(matches, selectorPath, selfSelector, allExtends[extendIndex].isVisible());
    ...
    findMatch(extend, haystackSelectorPath) {
        ...
        //
        let haystackSelectorIndex, hackstackSelector, hackstackElementIndex, haystackElement,
            targetCombinator, i;
