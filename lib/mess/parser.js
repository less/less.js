    ...
    return parser = {
        ...
        parse: function (str, callback) {
            ...
            root.toCSS = (function (evaluate) {
                ...
                return function (options, variables) {
                    ...
                    //
                    //
                    variables = tree.Reference.colors;
                    ...
                    env.errors = options.returnErrors ? [] : null;

                    try {
                        env.compress = env.compress || false
                        var css = evaluate.call(this, { frames: frames, error: env.error, errors: env.errors })
                                          .toCSS([], env);
                    } catch (e) {
                        throw errorData(e);
                    }
                    ...
                    if (env.errors && env.errors.length) {
                        for (var i = 0; i < env.errors.length; i++) {
                            env.errors[i] = errorData(env.errors[i])
                        }
                        return env.errors;
                    }
        ...
        parsers: {
            ...
            invalid: function () {
                ...
                // To fail gracefully, matche everything until a semicolon or linebreak.
                if (chunk = $(/^[^;\n]*[;\n]/)) {
