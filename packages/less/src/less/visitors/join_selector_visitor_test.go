...
func (mr *MockJoinRuleset) GetSelectors() []Selector {
	return mr.selectors
}

func (mr *MockJoinRuleset) SetSelectors(selectors []Selector) {
...
func TestJoinSelectorVisitor_VisitRuleset(t *testing.T) {
	...
	t.Run("should filter selectors by getIsOutput", func(t *testing.T) {
		...
		mockRuleset := &MockJoinRuleset{
			root:      false,
			selectors: []Selector{mockSelector1, mockSelector2, mockSelector3},
		}
		visitArgs := &VisitArgs{}
	...
	t.Run("should set selectors to nil when all selectors are filtered out", func(t *testing.T) {
		...
		mockRuleset := &MockJoinRuleset{
			root:      false,
			selectors: []Selector{mockSelector1, mockSelector2},
		}
		visitArgs := &VisitArgs{}
...
func TestJoinSelectorVisitor_ComplexScenarios(t *testing.T) {
	...
	t.Run("should handle mixed selector filtering scenarios", func(t *testing.T) {
		...
		mockRuleset := &MockJoinRuleset{
			root:      false,
			selectors: []Selector{outputSelector, hiddenSelector, outputSelector, hiddenSelector},
		}
