...
tree.Filterset.prototype.add = function(filter) {
    ...
    if (op === '=') {
        ...
        for (var k in this.filters) {
            if (this.filters[k].key == key && this.filters[k].val < filter.val) {
        ...
        for (var l in this.filters) {
            if (this.filters[l].key == key && this.filters[l].val >= filter.val) {
        ...
        for (var m in this.filters) {
            if (this.filters[m].key == key && this.filters[m].val > filter.val) {
