    ...
    return {
        ...
        mergeSelectors: function(selectors) {
            ...
            for (var i = 0; i < selectors.length; i++) {
                ...
                if (selector.filterID in byFilter) {
                    byFilter[selector.filterID].zoom |= selector.zoom;
                } else {
                    byFilter[selector.filterID] = selector;
                }
            }
        ...
        resolveConditions: function(definitions) {
            ...
            definitions.reduce(function(input, definition, i) {
                var next = [];
                var results = [];
                var main = definition.selector;
                ...
                return renderer.mergeSelectors(next);
            }, [new tree.Selector()]);
