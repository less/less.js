...
func (m *MockSelector) GetType() string {
	return "Selector"
}

func (m *MockSelector) Eval(context any) (any, error) {
	return &MockSelector{
		elements:       m.elements,
...
func (m *MockSelector) GetElements() []*Element {
	return m.elements
}

func (m *MockSelector) GetEvaldCondition() bool {
	return m.evaldCondition
}

func (m *MockSelector) GetCondition() any {
	return m.condition
}

func (m *MockSelector) IsJustParentSelector() bool {
	return len(m.elements) == 1 && m.elements[0].Value == "&"
}

func (m *MockSelector) ToCSS(context any) string {
	return ".mock-selector"
}

func (m *MockSelector) Match(other any) int {
	if o, ok := other.(*MockSelector); ok {
...
func (m *MockSelector) GenCSS(context any, output *CSSOutput) {
...
func TestRulesetGenCSS(t *testing.T) {
	...
	t.Run("should handle compressed output", func(t *testing.T) {
		...
		ruleset := NewRuleset(nil, []any{}, false, nil)
		ruleset.Paths = [][]any{{&MockSelector{}}}
...
func TestFind(t *testing.T) {
	...
	t.Run("should find matching rules", func(t *testing.T) {
		selector := &MockSelector{elements: []*Element{{Value: "div"}}}
		matchingRuleset := NewRuleset([]any{&MockSelector{elements: []*Element{{Value: "div"}}}}, nil, false, nil)
