...
tree.functions = {
    ...
    mix: function (color1, color2, weight) {
        color1 = transparentToRGBA(color1);
        color2 = transparentToRGBA(color2);
        if (!weight) {
...
function transparentToRGBA(color) {
    if (color.value === 'transparent') {
        return tree.functions.rgba(0, 0, 0, 0);
    } else {
        return color;
    }
}
