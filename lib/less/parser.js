        ...
        parse: function (str) {
            ...
            root.toCSS = (function (evaluate) {
                ...
                return function (options, variables) {
                    ...
                    try {
                        evaluate.call(this, { frames: frames }).then(function(evaluated) {
                            var css = evaluated.toCSS([], { compress: options.compress || false });
                            if (options.compress) {
                                css = css.replace(/(\s)+/g, "$1");
                            }
                            return css;
                        }, function(e) {
                            d.reject(errorHandler(e));
                        }).then(function(css) {
                            d.resolve(css);
                        }, function(err) {
                            d.reject(errorHandler(err));
                        });
                    } catch (e) {
                        d.reject(errorHandler(e))
                    }
        ...
        parsers: {
            ...
            "import": function () {
                ...
                if ($(/^@import\s+/) &&
                    ...
                    $(';')) {
                    return tree.newImport(path, imports);
                }
            },
