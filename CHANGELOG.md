...
### v5.0.0-alpha.1 (2026-07-27)

#### Changes

- [#4484](https://github.com/less/less.js/pull/4484) fix(release): sync release version from PR title (@matthew-dean)
- [#4466](https://github.com/less/less.js/pull/4466) fix(release): make release tag idempotent so a failed publish can be retried (@matthew-dean)
