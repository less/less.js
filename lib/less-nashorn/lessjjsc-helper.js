// lessjjsc_helper.js
//
//      helper functions for jjs
var lessjjsc_helper = {

    //Stylize a string
    stylize : function(str, style) {
        return str; // Testing on windows, this styling doesn't work
        var styles = {
            'reset'     : [0,   0],
            'bold'      : [1,  22],
            'inverse'   : [7,  27],
    ...
    printUsage: function() {
        console.log("usage: lessjjsc [jjs options] -- [option option=parameter ...] <source> [destination]");
        console.log("");
...
for (var h in lessjjsc_helper) { if (lessjjsc_helper.hasOwnProperty(h)) { exports[h] = lessjjsc_helper[h]; }}
