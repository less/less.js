...
function error(e, href) {
    ...
    if (e.stack) {
        ...
        content += 'on line ' + e.line + ', column ' + (e.column + 1) + ':</p>' +
                    '<code><ul>' + error.join('') + '</ul></code>';
    }
	
	//	Hey! I'm a LESS
	content += '<a href="http://lesscss.org/" target="_blank" class="less-logo">LESS</a>';
    ...
    createCSS([
        ...
        '.less-error-message .error {',
            ...
            'font-weight: bold;',
            'padding-bottom: 2px;',
            'border-bottom: 1px dashed #b35e4d;',
        '}',
		'.less-error-message .less-logo {',
