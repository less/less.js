...
var less = {
    version: [1, 1, 3],
    Parser: require(__dirname + '/../less/parser').Parser,
    importer: require(__dirname + '/../less/parser').importer,
    tree: require(__dirname + '/../less/tree'),
...
['color',    'directive', 'operation',  'dimension',
 ...
 'mixin',    'comment',   'anonymous',  'value', 'javascript'
    ...
    require(path.join(__dirname, '..', 'less', 'tree', n));
});
...
require(__dirname + '/../less/functions');
