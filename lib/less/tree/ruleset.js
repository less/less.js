...
export default class Ruleset extends Node {
    ...
    parseValue(toParse) {
        ...
        if (!Array.isArray(toParse)) {
            return transformDeclaration.call(this, toParse);
        }
        else {
            const nodes = [];
            toParse.forEach(n => {
                nodes.push(transformDeclaration.call(this, n));
            });
            return nodes;
        }
    }
    ...
    joinSelector(paths, context, selector) {
        ...
        function createSelector(containedElement, originalElement) {
            const element = new Element(null, containedElement, originalElement._index, originalElement._fileInfo);
        ...
        function replaceParentSelector(paths, context, inSelector) {
            ...
            function findNestedSelector(element) {
                ...
                const maybeSelector = element.value.value;
            ...
            for (i = 0; (el = inSelector.elements[i]); i++) {
                ...
                if (el.value !== "&") {
                    ...
                    if (nestedSelector != null) {
                        ...
                        const replaced = replaceParentSelector(nestedPaths, context, nestedSelector);
        ...
        newPaths = [];
        const hadParentSelector = replaceParentSelector(newPaths, context, selector);
