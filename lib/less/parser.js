var less, tree, charset; // The charset flag is used to keep only the first @charset definition
            ...
            directive: function () {
                ...
                if (value = $(this['import']) || $(this.media)) {
                    ...
                    if (name === '@font-face') {
                        ...
                        if (name === '@charset')  {
                    		// only accept the first @charset definition - skip 
                    		// subsequent ones and output them as comment
                    		if (charset) {
                        		return new(tree.Comment)("/* --- @charset "+value.toCSS()+" --- */\n");
                    		}
                			charset = true;
                    	}
