...
less.Parser = function Parser(env) {
    ...
    if (!env.imports) env.imports = [];

    // This function is called if there is an error
    // importing files through `@import`.
    var finish = function () {};
    ...
    return parser = {
        ...
        parse: function (str, callback) {
            ...
            finish = function (error) { callback(error, root); };
            ...
            // if we are still importing files, we will finish from there
