...
var Ruleset = /** @class */ (function (_super) {
    ...
    Ruleset.prototype.eval = function (context) {
        ...
        if (selectors && selectors.length > 0) {
            ...
            this.children.selectors = new (NodeArray.bind.apply(NodeArray, __spreadArrays([void 0], (util_1.mergeList()))))();
        }
        var selCnt;
        var selector;
        var i;
    ...
    Ruleset.prototype.parseValue = function (toParse) {
        ...
        function transformDeclaration(decl) {
            if (decl.value instanceof generic_1.default && !decl.parsed) {
    ...
    Ruleset.prototype.joinSelector = function (paths, context, selector) {
        function createParenthesis(elementsToPak, originalElement) {
            ...
            if (elementsToPak.length === 0) {
                replacementParen = new block_1.default(elementsToPak[0]);
            }
            else {
                ...
                replacementParen = new block_1.default(new selector_1.default(insideParent));
            }
        ...
        function replaceParentSelector(paths, context, inSelector) {
            ...
            function findNestedSelector(element) {
                var maybeSelector;
                if (!(element.value instanceof block_1.default)) {
                    return null;
                }
