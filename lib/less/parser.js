...
less.Parser = function Parser(env) {
    ...
    return parser = {
        ...
        parsers: {
            ...
            //
            ruleset: function () {
                var selectors = [], s, f, l, rules, match, filters = [];
                save();

                if (match = /^([.#: \w-]+)[\s\n]*\{/.exec(chunks[j])) {
                    i += match[0].length - 1;
                    // TODO: Handle Map and Layer
            ...
            "import": function () {
                ...
                if ($(/^@import\s+/) &&
                    ...
                    $(';')) {
                    throw "Import is not yet supported";
            ...
            directive: function () {
                ...
                if (value = $(this['import'])) {
                    ...
                    types = ($(/^[^{]+/) || '').trim();
                    if (rules = $(this.block)) {
                        throw "Directives are not yet supported";
