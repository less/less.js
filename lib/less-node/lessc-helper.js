...
var lessc_helper = {
    ...
    printUsage: function() {
        ...
        console.log("                               Works with or without the rewrite-urls option.");
        console.log("  -ru                          Re-writes urls to make them relative to the base less file.");
        console.log("  --rewrite-urls=all|relative  'all' rewrites all URLs, 'relative' just those starting with a '.'")
