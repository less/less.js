...
less.Parser = function Parser(env) {
    ...
    return parser = {
        ...
        parse: function (str, callback) {
            ...
            root = new(tree.Ruleset)([], $(this.parsers.primary), env.filename, input);
            root.root = true;
                ...
                return function (options, variables) {
                    ...
                    try {
                        ...
                        throw {
                            type: e.type,
                            message: e.message,
                            filename: e.filename || env.filename,
                            index: e.index,
        ...
        parsers: {
            ...
            ruleset: function () {
                ...
                if (selectors.length > 0 && (rules = $(this.block))) {
                    return new(tree.Ruleset)(selectors, rules, env.filename, input);
                } else {
                    // Backtrack
                    furthest = i;
                    restore();
