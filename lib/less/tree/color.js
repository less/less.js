...
tree.Color.prototype = {
    ...
    //
    // Returns true if the color is equivalent to 'transparent', false otherwise.
    // Although any color with an alpha of 0 will appear transparent, the RGB values can still affect things like gradients.
    // The CSS3 Color Module spec has this to say:
    // "This keyword can be considered a shorthand for transparent black, rgba(0,0,0,0), which is its computed value."
    //
    isFullyTransparent: function () {
        return (this.alpha === 0 && this.rgb[0] === 0 && this.rgb[1] === 0 && this.rgb[2] === 0);
    }
};
