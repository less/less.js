        ...
        parse: function (str, callback) {
            ...
            try {
                var currentRoot = $(function() {
                    return this.primary.call(this, true);
                });
                root = new(tree.Ruleset)([], currentRoot);
                root.root = true;
            } catch (e) {
        ...
        parsers: {
            ...
            primary: function (atRoot) {
                ...
                while ((node = $(this.mixin.definition) || $(this.rule)    ||  $(this.ruleset) ||
                               ...
                               || $(/^[\s\n]+/) || $(/^;+/)) {
                    node && root.push(node);
                    if (node && atRoot) { env.root.push(node); }
                }
                return root;
            },
            ...
            entities: {
                ...
                url: function () {
                    ...
                    if (value instanceof tree.Quoted) {
                        value = value.eval({ frames : [new tree.Ruleset(null, env.root)] });
                    }
            ...
            "import": function () {
                ...
                if (dir && (path = $(this.entities.quoted) || $(this.entities.url))) {
                    // For now, only quoted vars will be allowed
                    if (path instanceof tree.Quoted) {
                        path = path.eval({ frames : [new tree.Ruleset(null, env.root)] });
                    }
